          ...
          <div className="space-y-10">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                Врач-дерматокосметолог с 18-летним стажем работы, 
                эксперт в области эстетической медицины. 
                Моя миссия — помогать людям раскрыть их естественную красоту и обрести уверенность в себе через заботу о здоровье кожи.
                </p>
                <p>
                Выпускница ведущего медицинского вуза,
                прошла специализированную подготовку по дерматовенерологии и косметологии. 
                Постоянно совершенствую свои знания, посещая российские и международные конференции,
                осваивая передовые методики омоложения и эстетической коррекции.
                </p>
                <p>
                Мой подход основан на индивидуальном подходе и комплексных решениях,
                направленных на поддержание здоровья и молодости кожи.
                </p>
              </div>
            </motion.div>
